...
export default function RootLayout({
    ...
    return (
        <html lang="en" className={`scroll-smooth ${lato.className}`}>
                        ...
                        <div className="flex flex-1 items-center justify-end sm:justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="hidden sm:flex sm:gap-4">
                                    <Link
                                        className="rounded-md bg-sky-600 px-5 py-2.5  font-medium text-white transition hover:bg-sky-700 flex flex-row gap-3"
                                ...
                                <button className="block rounded bg-gray-100 p-2.5 text-gray-600 transition hover:text-gray-600/75 sm:hidden">
