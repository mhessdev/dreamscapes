				...
				<div className="grid md:grid-cols-2 h-fit gap-6">
					<div>
						...
						<p className="max-w-md mx-auto mt-4 text-gray-500">
							Our distributor{" "}
							<a
								href="https://www.brpoolsusa.com/"
								target="_blank"
								className="text-sky-500"
							>
								Barrier Reef Pools
							</a>{" "}
							offers a wide range of fiberglass pools that are
							designed to meet your unique style and preferences.
							Whether you are looking for a classic, modern, or
							custom design, Barrier Reef Pools has the perfect
							pool for you. Their pools are made with high-quality
							materials and expert craftsmanship, ensuring that
							you can enjoy a beautiful, durable, and
							low-maintenance pool for years to come.
						</p>
						<p className="max-w-md mx-auto mt-4 text-gray-500">
							<a
								href="https://www.brpoolsusa.com/pools-categories/pool-shape-rectangular/"
								target="_blank"
								className="text-sky-500"
							>
								Rectangular
							...
							,{" "}
							<a
								href="https://www.brpoolsusa.com/pools-categories/pool-shape-free-form/"
								target="_blank"
								className="text-sky-500"
							>
								free-form
							...
							,{" "}
							<a
								href="https://www.brpoolsusa.com/pools-categories/pool-shape-kidney/"
								target="_blank"
								className="text-sky-500"
							>
								kidney
							...
							, and{" "}
							<a
								href="https://www.brpoolsusa.com/pools-categories/pool-shape-plunge/"
								target="_blank"
								className="text-sky-500"
							>
								plunge fiberglass pools
							</a>
							, spas and more!{" "}
							<strong>Barrier Reef Fiberglass Pools LLC</strong>.
							offers many models, features, and colors to meet
							even the most demanding project requirements. When
							looking for fiberglass pools for sale, Barrier Reef
							provides the best swimming pools that provide years
							of backyard enjoyment.
						</p>
					</div>

					<Image
						src="/CoralSea_Ocean-Updated-scaled-800x600.jpg"
